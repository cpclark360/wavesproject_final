  ...
  var fn = {
    ...
    Clipboard: function() {
      var a = new ClipboardJS(".anchor", {
        text: function(b) {
          return (
            window.location.host + window.location.pathname + $(b).attr("href")
          );
        }
      });
...
// closes Navbar menu after the user makes a selection.

// Grandparent element to  ul containing navigation menu
